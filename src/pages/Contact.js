...
<section class="text-gray-600 body-font relative">
  <div class="container px-5 py-44 mx-auto">
    <div class="flex flex-col text-center w-full mb-12">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Let's Connect</h1>
    </div>
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        <div class="p-2 w-1/2">
          <div class="relative">
            <label for="name" class="leading-7 text-sm text-red-600 font-medium">Name</label>
        ...
        <div class="p-2 w-1/2">
          <div class="relative">
            <label for="email" class="leading-7 text-sm text-red-600 font-medium">Email</label>
        ...
        <div class="p-2 w-full">
          <div class="relative">
            <label for="message" class="leading-7 text-sm text-red-600 font-medium">Message</label>
        ...
        <div class="p-2 w-full">
          <button class="flex mx-auto text-white bg-gradient-to-br from-red-600 to-red-900 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-base">Send me a note</button>
        </div>
      </div>
    </div>
  </div>
